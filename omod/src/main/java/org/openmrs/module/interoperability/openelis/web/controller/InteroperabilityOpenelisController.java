 ...
 */
package org.openmrs.module.interoperability.openelis.web.controller;
 ...
 */
@Controller("${rootrootArtifactid}.InteroperabilityOpenelisController")
@RequestMapping(value = "module/${rootArtifactid}/${rootArtifactid}.form")
public class InteroperabilityOpenelisController {
